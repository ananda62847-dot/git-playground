...
GRANT SELECT, INSERT ON public.welfare_issues TO anon;
...
ON public.welfare_issues FOR SELECT USING (true);
...
GRANT SELECT, INSERT ON public.welfare_updates TO anon;
